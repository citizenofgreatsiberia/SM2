        ...
        <div className={overlayStyles}>
            <div className={wrapperStyles}>
                ...
                <p className={styles.text}>
                    ...
                    Сайт создан с целью практики в разработке веб-приложений с использованием библиотек React, React Router, Redux Toolkit, RTK Query и демонстрирует навыки работы с ними.
                    ...
                    Сайт НЕ предназначен для демонстрации кинематографической продукции неограниченному кругу лиц.
