        ...
        <div className={overlayStyles}>
            <div className={wrapperStyles}>
                ...
                <p className={styles.text}>
                    Сайт создан в рамках практики в разработке веб-приложений с использованием библиотек React, React Router, Redux Toolkit, RTK Query и демонстрирует навыки автора в работе с ними.
